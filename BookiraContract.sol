...
contract BKT is StandardToken {

    string public name = "BKT";
     ...
     * Token count
     */
    uint public totalTokens = 100000000;
    uint public team = 20000000;
    uint public bounty = 2000000; // Bounty count

    /**
     * Ico and pre-ico cap
     */
    uint public preIcoCap = 20000000; // Max amount raised during pre ico 4000000 USD (20%)
    uint public icoCap = 100000000; // Max amount raised during crowdsale 20000000 USD
    ...
    function BKT(address _founder) payable {
        owner = msg.sender;
        founder = _founder;
